...
import RentalApplication from "./js/components/RentalApplication/RentalApplication";
    ...
    return (
      <HashRouter className="container">
        <Switch>
          ...
          />
          <Route exact path="/AdminHelpResponse" component={AdminHelpResponse} />
          ...
          <Route exact path="/myAds/updateAd/:id" component={UpdateAdvertisement} />
